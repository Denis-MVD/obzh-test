...
st.markdown("""
    ...
    /* ПРИНУДИТЕЛЬНО БЕЛЫЙ ШРИФТ, КУРСИВ, ЖИРНЫЙ */
    /* Это исправит проблему невидимого текста */
    ...
    /* Заголовки на светлом фоне делаем темными для контраста */
    .stApp h1, .stApp h2 {
        color: #2f3526 !important;
        text-shadow: none;
    }

    /* Поля ввода и списки (темный фон, белый текст) */
...
# --- 4. ОТОБРАЖЕНИЕ АВТОМАТОВ (Иконки вместо нестабильных ссылок) ---
# Используем надежную векторную иконку автомата
st.image("https://img.icons8.com/ios-filled/100/2f3526/assault-rifle.png", width=100)
st.write("### Итоговый контроль знаний")
...
# --- 9. ЭКРАН 3: РЕЗУЛЬТАТ ---
    ...
    # Второй автомат в конце
    st.image("https://img.icons8.com/ios-filled/100/2f3526/assault-rifle.png", width=80)
